...
"$PYTHON" "$MEMAGENT_COSI_REPO_DIR/tools/h20/preflight_qwen25_7b_cosi.py" --manifest "$MEMAGENT_COSI_REPO_DIR/manifests/h20/qwen25_7b_cosi_seed2026.json" --stage t5 --write-certificate
...
export N_GPUS=2 FSDP_SIZE=2 FRESH_TOTAL_STEPS=5 SAVE_FREQ=1 MAX_ACTOR_CKPT_TO_KEEP=30
...
echo "CORAL_T5_TRAINING_COMPLETE:$OUTPUT/global_step_5"
