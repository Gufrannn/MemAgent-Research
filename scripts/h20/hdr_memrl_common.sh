...
readonly HDR_EXP=qwen25_7b_hdr_memrl_seed2026_$HDR_RUN_ID
...
hdr_require_gates() {
  "$HDR_PYTHON" - "$HDR_CERT" <<'PY'
import json,os,sys
from pathlib import Path
p=Path(sys.argv[1]); expected={"p0.json":"HDR_P0_PASS","e0.json":"HDR_E0_PASS","e1.json":"HDR_E1_PASS","baseline_import.json":"ORIGINAL_BASELINE_IMPORT_PASS","paper_review.json":"PAPER_FRAMING_GO"}
