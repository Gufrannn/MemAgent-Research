...
class OrchestrationTests(unittest.TestCase):
    ...
    def test_h20_release_has_real_materializers_and_post_t25_producer(self):
        ...
        self.assertIn("data-overlap)",entry)
        ...
        overlap=(REPO/"tools/h20/audit_prd_data_overlap.py").read_text()
        self.assertIn("train_pool_and_s128_content",overlap)
        self.assertIn("selection_and_s128\":128",overlap.replace(" ",""))
